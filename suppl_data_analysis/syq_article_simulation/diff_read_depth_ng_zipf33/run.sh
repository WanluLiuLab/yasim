...
function generate_depth() {
    LOG_FILE_NAME="yasim_generate_gene_depth_${1}.log" \
        ...
        -g ce11_as_3.gtf.gz \
        -o ce11_as_3_gene_depth_"${1}".tsv.xz \
        -d "${1}" \
        --low_cutoff 0
    LOG_FILE_NAME="yasim_generate_isoform_depth_${1}.log" \
        python -m yasim generate_isoform_depth \
        -g ce11_as_3.gtf.gz \
        -d ce11_as_3_gene_depth_"${1}".tsv.xz \
        -o ce11_as_3_isoform_depth_"${1}".tsv.xz \
        --alpha 3 \
        --low_cutoff 0
}
...
#         ce11_as_3_isoform_depth_100.tsv.xz \
#         ce11_as_3_isoform_depth_"${mean_depth}".tsv.xz \
#         "0.${mean_depth}" &
# done
# wait

for mean_depth in 10 25 40 55 70; do
    perform_simulation ce11_as_3_isoform_depth_"${mean_depth}" ce11_as_3_isoform_depth_"${mean_depth}"
done
wait
