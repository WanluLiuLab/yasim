...
minimap2 -x splice -a -t 50 ce11.reference_transcripts.fa.mmi ERR3245471.fastq.gz ERR3245470.fastq.gz | \
samtools sort -@ 50 -o NANO_TRANS.bam # 84.24% mapping rate
minimap2 -x splice -a -t 50 ce11.reference_transcripts.fa.mmi SRR8568877_subreads.fastq.gz SRR8568878_subreads.fastq.gz | \
