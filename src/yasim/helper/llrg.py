...
def patch_frontend_parser_public(
    ...
    parser.add_argument(
        ...
        '--fastas',
        required=True,
        help="Directory of transcribed DGE FASTAs from `transcribe` step",
        nargs='?',
        type=str,
        action='store'
    )
    parser.add_argument(
        ...
        '--jobs',
        required=False,
        help="Number of parallel LLRGs", nargs='?',
        type=int,
        action='store',
...
def patch_frontend_parser_bulk_rna_seq(
    ...
    """
    Patch argument parser for Bulk RNA-Seq
    ...
    parser.add_argument(
        ...
        '--depth',
        required=True,
        help="Depth directory generated by `generate_barcoded_isoform_replicates`",
        nargs='?',
        type=str,
        action='store'
    )
...
def patch_frontend_parser_sc_rna_seq(
    ...
    parser.add_argument(
        ...
        '--depth',
        required=True,
        help="Depth generated by `generate_depth_v2` or `generate_isoform_depth` step",
        nargs='?',
        type=str,
        action='store'
    )
    parser.add_argument(
        ...
        help="Output transcript prefix. "
             "The output file would be {out}.fq foe single-end "
...
def patch_frontend_parser_tgs(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        '--truncate_ratio_3p',
        required=False,
        help="Ratio of 3 prime truncation, range from 0 (no truncation) to 1 (truncate all).",
        nargs='?',
        type=float,
        action='store',
        default=0.0
    ...
    parser.add_argument(
        '--truncate_ratio_5p',
        required=False,
        help="Ratio of 5 prime truncation, range from 0 (no truncation) to 1 (truncate all).",
        nargs='?',
        type=float,
        action='store',
        default=0.0
