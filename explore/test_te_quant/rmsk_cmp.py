...
if __name__ == "__main__":
    for n in ("hmmer", "rmblast"):
        RMSK_OUT_GFF_PATH = f"aln/ce11_denovo_test_rmsk_prep.{n}.d/ce11_denovo_test_rmsk_prep.fa.out.gff"
        RMSK_CONVERT_JSON_PATH = "sim/ce11_denovo_test_rmsk_prep.json"
        GROUND_TRUTH_TI_PATH = "sim/ce11_denovo_test.json"
        OUT_TSV_PATH = f"aln/ce11_denovo_test_rmsk_prep.{n}.comp"
