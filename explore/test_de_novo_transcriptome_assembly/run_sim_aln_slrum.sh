...
STAR \
    ...
    --twopassMode Basic
mv aln/ce11_denovo_test_art_STAR/Aligned.sortedByCoord.out.bam aln/ce11_denovo_test_art.bam
...
rsem-calculate-expression \
    ...
    sim/ce11_denovo_test_rsem/ref \
    sim/ce11_denovo_test_rsem/expr
samtools sort \
    -@ 40 \
    sim/ce11_denovo_test_rsem/expr.transcript.bam \
    -o sim/ce11_denovo_test_rsem/expr.transcript.sorted.bam
samtools index sim/ce11_denovo_test_rsem/expr.transcript.sorted.bam
