...
def _main():
    ...
    parser.add_argument("--transform", nargs="+", required=False, choices=("scale", "log"), default=[])
    ...
    model = GaussianMixture1D(n_components=args.numComponents, n_iter=args.numIters).fit(data)
