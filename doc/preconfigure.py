...
copy_doc_files(os.path.join(ROOT_DIR, "fig", "*"), os.path.join(THIS_DIR, "_root", "fig"))
...
myst_nb_helper.generate_cli_docs(
    os.path.join(THIS_DIR, "cli_docs.toml"), os.path.join(THIS_DIR, "_cli_docs"), format="txt"
)
